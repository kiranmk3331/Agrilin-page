...
const StatusSummary = () => {
  return (
    <div className="bg-white border border-[#CBDDA1] shadow p-6 mt-6 rounded-md items-center w-full font-lexend">
      <div className="flex justify-between">
        <h1 className="text-[#242731] font-semibold">Order Status Summary</h1>
